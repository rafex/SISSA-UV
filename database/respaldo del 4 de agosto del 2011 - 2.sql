...
# Dumping data for table serviciosocial_fca_uv.alumno_ss_fca: ~177 rows (approximately)
...
INSERT INTO `alumno_ss_fca` (`MatriculaAlu`, `NombreAlu`, `CarreraAlu`, `SeccionAlu`, `PeriodoAlu`, `EmailAlu`, `TelefonoAlu`, `CriterioAlu`, `PassAlu`) VALUES
	...
	('S07007012', 'MAGAÃ‘A CASTRO JAIME DE JESUS', 'la', NULL, 'ENERO2011-JUNIO2011', NULL, NULL, 'MEIFv1', NULL),
	...
	('S07007121', 'AVENDAÃ‘O ARAUJO INGRID MELISA', 'la', NULL, 'ENERO2011-JUNIO2011', NULL, NULL, 'MEIFv1', NULL),
	...
	('S07008302', 'TREVIÃ‘O GUERSON ALFREDO', 'lc', NULL, 'ENERO2011-JUNIO2011', NULL, NULL, 'MEIFv1', NULL),
	...
	('S07008320', 'SANCHEZ PEÃ‘A MARIO ALBERTO', 'lc', NULL, 'ENERO2011-JUNIO2011', NULL, NULL, 'MEIFv1', NULL),
	...
	('S07015270', 'HERNANDEZ CASTAÃ‘EDA ALEJANDRO', 'la', NULL, 'ENERO2011-JUNIO2011', NULL, NULL, 'MEIFv1', NULL),
	...
	('S07015288', 'AROCHI MUÃ‘OS BOSCO', 'la', NULL, 'ENERO2011-JUNIO2011', NULL, NULL, 'MEIFv1', NULL),
	...
	('S07023294', 'CASTAÃ‘EDA GOMEZ RAFAEL ESTEBAN', 'lsca', '701', 'ENERO2011-JUNIO2011', NULL, NULL, 'MEIFv1', NULL),
	...
	('S08010063', 'LANDA TRILLO RUBÃ‰N ADRÃAN', 'lg', NULL, 'ENERO2011-JUNIO2011', NULL, NULL, 'MEIFv1', NULL),
	...
	('S09013831', 'VIVEROS GONZÃLEZ MAYRA ALEJANDRA', 'lsca', NULL, 'ENERO2011-JUNIO2011', NULL, NULL, 'MEIFv1', NULL),
...
# Dumping data for table serviciosocial_fca_uv.datos_extra_alumno: 1 rows
...
INSERT INTO `datos_extra_alumno` (`MatriculaAlu`, `generoalu`, `edocivilalu`, `edadalu`, `nacionalidadalu`, `nacimientoalu`, `lugarnacimientoalu`, `calledireccion`, `numdireccion`, `coloniadireccion`, `cpdireccion`, `estadoalu`, `municipioalu`, `localidadalu`, `tutoralu`, `direcciontutor`) VALUES
	('s07012161', 'm', 'solter@', 22, 'MEXICANO', '1989-07-03', 'VERACRUZ', 'retorno loma reyna', '56 letra A', 'lomas verdes', 91097, 'veracruz', 'xalapa', 'xalapa', 'RAUL EDUARDO GONZALEZ AROGTE', 'bugambilias');
...
# Dumping data for table serviciosocial_fca_uv.empresa_ss_fca: ~2 rows (approximately)
...
INSERT INTO `empresa_ss_fca` (`IdEmp`, `NombreEmp`, `DireccionEmp`, `EmailEmp`, `TelefonoEmp`, `Telefono2Emp`, `ClasificacionEmp`, `SectorEmp`, `AcuerdoEmp`, `GiroEmp`, `EstadoEmp`, `MunicipioEmp`, `LocalidadEmp`) VALUES
	(1, 'VERACRUZ', 'soconusco S/N, aguacatal aguacatal', 'contacto@ssaver.mx', 0, 1, 'PUBLICO', 'terciario', 'se tiene y se desea mantener', 'servicios', NULL, NULL, NULL),
	(2, 'VERACRUZ', 'soconusco s/n, aguacatal aguacatal', 'ssaver@ssaver.com', 12346679, 123456789, 'SECTOR PUBLICO', 'terciario', 'se tiene y se desea mantener', 'servicios', NULL, NULL, NULL);
...
# Dumping data for table serviciosocial_fca_uv.encargado_ss_fca: ~2 rows (approximately)
/*!40000 ALTER TABLE `encargado_ss_fca` DISABLE KEYS */;
INSERT INTO `encargado_ss_fca` (`IdEnc`, `NombreEnc`, `PuestoEnc`, `EmailEnc`) VALUES
	(1, 'MIGUEL', 'PROGRAMADOR', 'encargado@ssaver.mx'),
	(2, 'MIGUEL', 'PROGRAMADOR', 'miguel@ssaver.mx');
...
# Dumping data for table serviciosocial_fca_uv.historial_alumno_ss_fca: ~1 rows (approximately)
/*!40000 ALTER TABLE `historial_alumno_ss_fca` DISABLE KEYS */;
INSERT INTO `historial_alumno_ss_fca` (`MatriculaAlu`, `IdAcu`, `FuncionHist`, `TipoHist`, `JefeDirectoHist`, `AreaHist`, `EvaluacionHist`) VALUES
	('s07012161', 0000000000, 'PROGRAMAR POR 4', 'becado', 'MIGUEL', 'INFORMATICA', NULL);
