...
<form id="evaluacion" name="evaluacion" method="post" action="javascript:evaluar('matricula,nombre,criterio','<? echo $matricula; ?>,<? echo $nombre; ?>,<? echo $criterio; ?>','evaluacion.php');">	
    <? } ?>
